...
public class ContractModel extends Model {
	...
	public static ContractModel findByFriendlyUrl(String friendlyUrl) {
	...
	public String getShortenUrl() {
		if (Utils.isNullOrEmpty(this.shortenUrl) && !Utils.isNullOrZero(this.id) && !Utils.isNullOrEmpty(this.friendlyUrl)) {
			...
			setShortenUrl(Utils.getShortenUrl(parameter.getGoogleShortnerUrlApiId(), Parameter.getCurrentParameter().getSiteDomain() + "/modelo-de-contrato/".concat(String.valueOf(this.id)).concat("/").concat(this.getFriendlyUrl())));
		}
		return shortenUrl;
	}
