...
public class MemberCRUD extends CRUD {
	...
	public static void list(int page, String search, String searchFields, String orderBy, String order) {
		...
		try {
			...
			render("MemberCRUD/list.html", type, objects, count, totalCount, page, orderBy, order);
		}
	}
	...
	public static void blank() throws Exception {
		...
		Member object = (Member) constructor.newInstance();
	...
	public static void create() throws Exception {
		...
		object._save();
		/* Generate Activity */
		String activityTitle = "Membere \"" + object.name + " " + object.lastName + "\" cadastrado";
