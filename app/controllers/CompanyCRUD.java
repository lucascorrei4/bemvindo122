...
public class CompanyCRUD extends CRUD {
	...
	public static void show(String id) throws Exception {
		...
		Company object = Company.find("id = " + id + " and institutionId = " + Admin.getLoggedUserInstitution().getInstitution().getId()).first();
	...
	public static void create() throws Exception {
		...
		Company object = (Company) constructor.newInstance();
