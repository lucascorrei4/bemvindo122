...
public class VisitorCRUD extends CRUD {
	...
	public static void list(int page, String search, String searchFields, String orderBy, String order) {
		...
		try {
			...
			render("VisitorCRUD/list.html", type, objects, count, totalCount, page, orderBy, order);
		}
	}
	...
	public static void blank() throws Exception {
		...
		Visitor object = (Visitor) constructor.newInstance();
	...
	public static void create() throws Exception {
		...
		object._save();
		/* Generate Activity */
		String activityTitle = "Visitante \"" + object.name + " " + object.lastName + "\" cadastrado";
